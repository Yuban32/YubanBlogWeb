            ...
            <div class="about-content" ref="aboutContent">
                <div class="profile">
                    ...
                    <div class="profile-desc">
                        ...
                        <p>建站的原因：其实我一直都在想独立完成自己的一个博客，但学业繁忙一直没有时间去写。
                            下定决心抽空来完成这个博客的导火索应该是21年11月中旬，学校举办了一个网页设计大赛，
                            心想着又能参加比赛，又能通过项目来提升自身的编程能力。</p>
                        <p>本站所用的技术栈是Vue3、Vue-Router、Vitepress，纯手工打造。</p>
                        ...
                        <p>关于此协议的详细内容请点击下发的链接：</p>
                        <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh">https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh</a>
                    </div>
                </div>
            </div>
        </div>
